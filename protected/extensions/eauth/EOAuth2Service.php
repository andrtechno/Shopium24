...
/**
 * EOAuth2Service class file for all OAuth 2.0 providers.
 *
...
abstract class EOAuth2Service extends EAuthServiceBase implements IAuthService {
     ...
     */
    protected $client_id; //change protected to public

    /**
     * @var string OAuth2 client secret key.
     */
    protected $client_secret; //change protected to public
    ...
    public function makeSignedRequest($url, $options = array(), $parseJson = true) {
        ...
        $options['query'] =
                array_merge(
                isset($options['query']) ? $options['query'] : array(), $this->getSignedRequestFields()
        );
