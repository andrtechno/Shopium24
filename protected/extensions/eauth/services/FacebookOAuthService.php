...
class FacebookOAuthService extends EOAuth2Service {
    ...
    const APP_URL = 'https://developers.facebook.com/apps/';
    ...
    public function getConf() {
        ...
        $this->client_id = (isset($c['facebook_client_id']) && !empty($c['facebook_client_id'])) ? $c['facebook_client_id'] : $this->client_id;
        $this->client_secret = (isset($c['facebook_client_secret']) && !empty($c['facebook_client_secret'])) ? $c['facebook_client_secret'] : $this->client_id;
    }
