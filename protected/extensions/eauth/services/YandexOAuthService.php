...
class YandexOAuthService extends EOAuth2Service {
    ...
    const APP_URL = 'https://oauth.yandex.ru/client/my';

    public $name = 'yandex_oauth';
    ...
    public function getConf() {
        ...
        $this->client_id = (isset($c['yandex_oauth_client_id']) && !empty($c['yandex_oauth_client_id'])) ? $c['yandex_oauth_client_id'] : $this->client_id;
        $this->client_secret = (isset($c['yandex_oauth_client_secret']) && !empty($c['yandex_oauth_client_secret'])) ? $c['yandex_oauth_client_secret'] : $this->client_id;
    }
