    ...
    <div class="ap-container-fluid">
        <div class="ap-navbar-header">
            ...
            <a class="ap-navbar-brand" href="#">
                <i class="ap-favicon"></i>
            </a>
        </div>
        <div id="ap-navbar" class="ap-navbar-collapse hidden">
                    ...
                    <?php if (isset($row['items'])) { ?>
                        <li <?php echo (isset($row['items'])) ? 'class="dropdown "' : 'class="panelObj"'; ?>>
                            <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle" href="<?php echo CHtml::normalizeUrl($row['url']) ?>">
                                <?= $row['label'] ?> <span class="caret"></span></a>
                                <?php if (isset($row['items'])) { ?>
            ...
            <div class="ap-navbar-form ap-navbar-nav">
                <div class="ap-btn-group2">
                    ...
                    if ($dataModel->scenario == 'update') {
                        ...
                        echo Html::link('<i class="flaticon-add"></i>', $dataModel->getCreateUrl(), array(
                    ...
                    <?php
                    if ($dataModel->scenario == 'update') {
                        echo Html::link('<i class="flaticon-edit"></i>', $dataModel->getUpdateUrl(), array(
...
<div id="admin-panel" class="ap ap-fixed-top" style="display:none">
