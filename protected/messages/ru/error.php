...
return array(
    ...
    '403' => 'Запрещено.',
    /**/
    '404' => 'Что-то явно пошло не так как хотелось, произошла ошибка. Этой странички не существует.<br/>Самая главная страница работает всегда, скорей же посетите ее.', //  Страница не найдена.
