...
class SettingsUsersForm extends FormModel {
                ...
                'class' => 'form-horizontal',
                    ...
                    'elements' => array(
                        'main' => array(
                            ...
                            'elements' => array('friends' => array('type' => 'checkbox'),
                                'upload_avatar' => array('type' => 'checkbox'),
                                'upload_types' => array(
                                    'type' => 'TagInput',
                                    'options' => array(
                                        'defaultText' => 'Добавить формат'
                                    )
                                ),
                                'upload_size' => array(
                                    'type' => 'text',
                                ...
                                'bad_name' => array(
                                    'type' => 'TagInput',
                                    'options' => array(
                                        'defaultText' => 'Добавить Имя'
                                    )
                                ),
                                'bad_email' => array('type' => 'TagInput',
                                    'options' => array(
                                        'defaultText' => 'Добавить сервис'
                                    )
                                ),
    ...
    public function rules() {
        $rules = array(
            array('favorite_limit, upload_types ,upload_size, avatar_size, min_password', 'required'),
            array('bad_name, bad_email', 'length', 'max' => 255),
            array('favorite_limit', 'length', 'max' => 2),
            ...
            array('favorite_limit, min_password', 'numerical', 'integerOnly' => true),
            array('friends, favorites, register_nomail, registration, upload_avatar', 'boolean'),
            array('change_theme, social_auth', 'boolean')
