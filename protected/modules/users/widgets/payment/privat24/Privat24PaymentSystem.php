...
//print_r($forHash);
    ...
    public function renderPaymentForm(ShopPaymentMethod $method, Order $order) {
        ...
        $html = strtr($html, array(
            ...
            '{SUCCESS_URL}' => Yii::app()->createAbsoluteUrl('/users/payment/process', array('payment_id' => $method->id)),
            '{RESULT_URL}' => Yii::app()->createAbsoluteUrl('/users/payment/process', array('payment_id' => $method->id, 'result' => true)),
