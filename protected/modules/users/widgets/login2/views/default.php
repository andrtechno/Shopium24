    ...
    <li class="dropdown dropdown-small">
        ...
        <ul class="dropdown-menu">
            ...
            if (Yii::app()->user->isSuperuser) {
                echo Html::openTag('li');
                echo Html::link('<span class="icon-wrench"></span>' . Yii::t('app', 'ADMIN_PANEL'), array('/admin'));
                echo Html::closeTag('li');
            }
            ?>
            <li><?= Html::link('<span class="icon-exit"></span>' . Yii::t('app', 'ORDERS'), Yii::app()->createUrl('/users/profile/orders')); ?></li>
