...
class DefaultController extends AdminController {
    ...
    public function actionUpdate($new = false) {
        ...
        if (Yii::app()->request->isPostRequest) {
            ...
            if ($model->validate()) {
                ...
                $model->updateExpiredUser();
                $title = ($model->isNewRecord) ? Yii::t('CartModule.admin', 'Создание заказа') :
                        Yii::t('CartModule.admin', 'Редактирование заказа');
                $this->pageName = $title;
                ...
                $this->breadcrumbs = array(
                    ...
                    ($model->isNewRecord) ? Yii::t('CartModule.admin', 'Создание заказа') : '# ' . CHtml::encode($model->id),
                );
    ...
    public function error404() {
        throw new CHttpException(404, Yii::t('CartModule.admin', 'Заказ не найден.'));
    }
