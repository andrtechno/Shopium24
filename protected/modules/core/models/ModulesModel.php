    ...
    public static function install($name) {
        ...
        if (self::loadModuleClass($name)->afterInstall()) {
            ...
            if ($model->save(false, false)) {
                Yii::app()->user->setFlash('success', Yii::t('CoreModule.admin', 'SUCCESS_INSTALL_MODULE'));
            }
        } else {
            Yii::app()->user->setFlash('error', Yii::t('CoreModule.admin', 'ERROR_INSTALL_MODULE'));
            // Yii::app()->controller->setFlashMessage(Yii::t('CoreModule.admin', 'ERROR_INSTALL_MODULE'));
            return false;
        }
        self::deleteCaches();
