<div class="row">
    ...
    <div class="col-lg-6">
        ...
        echo Html::form('', 'POST', array('class' => 'form-horizontal'));
        ?>
        ...
        <div class="form-group">
            <div class="col-sm-12 text-center">
                ...
                $this->widget('ext.bootstrap.selectinput.SelectInput', array(
                    'name' => 'type',
                    'data' => array('optimize' => Yii::t('app', 'OPTIMIZE_DB'), 'repair' => Yii::t('app', 'REPAIR_DB')),
                    'value' => (isset($_POST['type'])) ? $_POST['type'] : null
                ));
                ?>
        ...
        if ($_POST['type'] == 'optimize') {
            ...
            ?>
            <ul class="list-group">
                <li class="list-group-item"><?= Yii::t('app', 'OPTIMIZE_DB') ?>: <span class="label label-default"><?= CMS::tableName() ?></span></li>
                <li class="list-group-item"><?= Yii::t('app', 'TOTAL_SIZE_DB') ?>: <span class="label label-default"><?= CMS::files_size($totaltotal) ?></span></li>
                <li class="list-group-item"><?= Yii::t('app', 'TOTAL_OVERHEAD') ?>: <span class="label label-default"><?= CMS::files_size($totalfree) ?></span></li>
            </ul>
