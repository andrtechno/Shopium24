            ...
            <div class="list-group">
                ...
                foreach ($data['support']['members'] as $members) {
                    ...
                    <?php if (isset($members['contact']['phone'])) { ?>
                        <div class="list-group-item">
                            <div><i class="flaticon-phone-call"></i> <?= $members['contact']['phone'] ?></div>
                        </div>
                    <?php } ?>
                    <?php if (isset($members['contact']['email'])) { ?>
                        <div class="list-group-item">
                            <div><i class="flaticon-envelope-open"></i> <?= $members['contact']['email'] ?></div>
                        </div>
                    <?php } ?>

                <?php } ?>
                <div class="list-group-item">
                    <div><i class="flaticon-location"></i> <?= $data['support']['address'] ?></div>
                </div>
            </div>
