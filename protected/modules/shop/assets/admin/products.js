...
$('#ShopProduct_use_configurations, #ShopProduct_type_id').change(function(){
	...
	$.getJSON('/admin/shop/products/loadConfigurableOptions/?type_id='+type_id, function(data){
		...
		$.each(data, function(key, option) {
			items.push('<li style="clear: both;"><label><input type="checkbox" class="check" name="ShopProduct[configurable_attributes][]" value="' + option.id + '" name=""> ' + option.title + '</label></li>');
		});
