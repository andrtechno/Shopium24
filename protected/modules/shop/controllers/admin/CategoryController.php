        ...
        if (Yii::app()->request->isPostRequest) {
            ...
            if ($model->validate()) {
                ...
                if (isset($_GET['parent_id'])) {
                    $parent = ShopCategory::model()->language(Yii::app()->language->active)->findByPk($_GET['parent_id']);
                } else {
                    $parent = ShopCategory::model()->language(Yii::app()->language->active)->findByPk(1);
                }
