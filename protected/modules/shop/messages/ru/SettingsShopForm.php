...
return array (
  ...
  'SAVE_FIELDS_ON_CREATE' => 'Запоминать поля при создание товара?',
  ...
  'PRODUCT_BUTTON_UPDATE' => 'Действие кнопки редактирование после нажатие',
  'PRODUCT_BUTTON_UPDATE_ITEMS' => '0#Остатся в редактирование|1#Редирект в список',
