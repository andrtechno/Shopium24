    ...
    <div id="operations">
        ...
        <?php
        $this->beginClip('help');
        Yii::app()->tpl->alert('info', Rights::t('default', 'An operation is a permission to perform a single operation, for example accessing a certain controller action.'), false);
        Yii::app()->tpl->alert('info', Rights::t('default', 'Operations exist below tasks in the authorization hierarchy and can therefore only inherit from other operations.'), false);
        $this->endClip();
        ?> 
        <?= $this->clips['help'];?>
