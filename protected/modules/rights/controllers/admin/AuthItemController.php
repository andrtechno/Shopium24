...
class AuthItemController extends AdminController {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['AuthItemForm']) === true) {
            ...
            if ($formModel->validate() === true) {
                ...
                Yii::app()->user->setFlash($this->module->flashSuccessKey, Rights::t('default', ':name created.', array(':name' => $item->getNameText()))
                );
    ...
    public function actionUpdate() {
        ...
        if (isset($_POST['AuthItemForm']) === true) {
            ...
            if ($formModel->validate() === true) {
                ...
                Yii::app()->user->setFlash($this->module->flashSuccessKey, Rights::t('default', ':name updated.', array(':name' => $item->getNameText()))
                );
        ...
        if ($childSelectOptions !== array()) {
            ...
            if (isset($_POST['AuthChildForm']) === true) {
                ...
                if ($childFormModel->validate() === true) {
                    ...
                    Yii::app()->user->setFlash($this->module->flashSuccessKey, Rights::t('default', 'Child :name added.', array(':name' => $child->getNameText()))
                    );
    ...
    public function actionDelete() {
        ...
        if (Yii::app()->request->isPostRequest === true) {
            ...
            Yii::app()->user->setFlash($this->module->flashSuccessKey, Rights::t('default', ':name deleted.', array(':name' => $item->getNameText()))
            );
