...
class News extends ActiveRecord {
    ...
    public function getTitle() {
        if ($this->isEditMode()) {
            ...
            $html .= '<span id="News[title]" class="edit_mode_title">' . $this->title . '</span>';
            $html .= '</form>';
            return $html;
        } else {
            return $this->title;
    ...
    public function getText() {
        if ($this->isEditMode()) {
            $html = '<form action="' . $this->getUpdateUrl() . '" method="POST">';
            $html .= '<div id="News[full_text]" class="edit_mode_text">' . $this->full_text . '</div>';
            $html .= '</form>';
            return $html;
        } else {
            ...
            'elements' => array(
                'content' => array(
                    ...
                    'elements' => array(
                        ...
                        'category_id' => array(
                            'type' => 'SelectInput',
                            'data' => Html::listData($categories, 'id', 'name'),
    ...
    public function behaviors() {
        ...
        $a['preview'] = array(
            ...
            'versions' => array(
                'small' => array(
                    'resize' => array(162, false),
                ),
                'medium' => array(
                    'resize' => array(270, false),
                ),
                'large' => array(
                    'resize' => array(360, false),
                ),
            //'medium' => array(
