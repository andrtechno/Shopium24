...
class APIConstants {
    ...
    public static $LANG_ALIAS = "ApiModule.api";
    ...
    //Ошибка если не найден перевод.
    public static $ERROR_LANG_CODE = 101;
    
    

    /* api hosting ukraine */
     public static $BASE_SITE = 'corner-cms.com';
    //public static $PARTER_ID = 127522;
    //public static $API_URL = 'https://adm.tools/api.php';
    //public static $AUTH_LOGIN = 'psevdobum@gmail.com';
    //public static $AUTH_TOKEN = '6d7sbv3a59dv713y3vn1f344a7a14y938bc3yv38e47lbeaber54872225ef3j3h';
