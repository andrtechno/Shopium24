...
class SuperPager extends CBasePager {
    ...
    protected function createShowMoreButton($label, $page, $data) {
        ...
        return Html::link($label, $this->createShowMoreUrl($this->getController(), $page, $data), array('id' => 'showmore'));
    }
    ...
    public function createShowMoreUrl($controller, $page, $data) {
        ...
        if ($page > 0) { // page 0 is the default
            ...
            $params['limit'] = $result['limit'][$page - 1];
            $params['current_page'] = $this->get_cp; //-1
