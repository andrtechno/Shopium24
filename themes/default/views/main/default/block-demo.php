            ...
            <div class="row text-center">
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="text-center">
                        <a href="//demo.buildshop.net" class="btn btn-lg btn-info">Демонстрация витрины</a>
                        <a href="//demo.buildshop.net/admin" class="btn btn-lg btn-warning">Демонстрация админ-панели</a>
                    </div>
